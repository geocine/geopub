...
(function codeSnippets() {
    // Playground integration removed: no external requests or run buttons
...
aria-label="Show hidden lines"></button>';
    ...
    // Always add copy-to-clipboard buttons for all code blocks
    Array.from(document.querySelectorAll('pre code')).forEach(function(block) {
        ...
        if (!buttons.querySelector('button.clip-button')) {
    ...
    // No special handling for `.playground` blocks
})();
...
(function themes() {
    ...
    function get_saved_theme() {
        let theme = null;
        try {
            theme = localStorage.getItem('geopub-theme');
        } catch {
            // ignore error.
        }
        return theme;
    ...
    function delete_saved_theme() {
        localStorage.removeItem('geopub-theme');
    }
    ...
    function set_theme(theme, store = true) {
        ...
        if (store) {
            try {
                localStorage.setItem('geopub-theme', theme);
            } catch {
                // ignore error.
            }
        }
...
(function sidebar() {
    ...
    function showSidebar() {
        ...
        try {
            localStorage.setItem('geopub-sidebar', 'visible');
        } catch (e) {
            // Ignore error.
        }
    }
    ...
    function hideSidebar() {
        ...
        try {
            localStorage.setItem('geopub-sidebar', 'hidden');
        } catch {
            // Ignore error.
        }
    }
...
(function chapterNavigation() {
    document.addEventListener('keydown', function(e) {
        ...
        function showHelp() {
            const container = document.getElementById('geopub-help-container');
            const overlay = document.getElementById('geopub-help-popup');
            ...
            document.getElementById('geopub-help-container')
                .addEventListener('mousedown', mouseHandler);
        }
        function hideHelp() {
            document.getElementById('geopub-help-container').style.display = 'none';
        }
